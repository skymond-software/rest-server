...
#endif // defined(_WIN64) || defined(_WIN32) || defined(__WIN32__)
#endif // MZ_PLATFORM
...
// external attributes is a 32-bit value that maps as follows:
// TTTTsstrwxrwxrwx0000000000ADVSHR
// ^^^^____________________________ UNIX file type as explained below
...
// - 0xa = symbolic link
// - 0xc = socket
#define MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_FIFO       (0x1 << 28)
#define MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_CHARACTER  (0x2 << 28)
#define MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_DIRECTORY  (0x4 << 28)
#define MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_BLOCK      (0x6 << 28)
#define MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_REGULAR    (0x8 << 28)
#define MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_SYMBOLIC   (0xa << 28)
#define MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_SOCKET     (0xc << 28)
#define MINIZ_ATTRIBUTE_UNIX_SETUID               ( 1  << 27)
#define MINIZ_ATTRIBUTE_UNIX_SETGID               ( 1  << 26)
#define MINIZ_ATTRIBUTE_UNIX_STICKY               ( 1  << 25)
#define MINIZ_ATTRIBUTE_UNIX_PERMISSIONS(X)       ((X) << 16)
#define MINIZ_ATTRIBUTE_DOS_ARCHIVE               ( 1  <<  5)
#define MINIZ_ATTRIBUTE_DOS_DIRECTORY             ( 1  <<  4)
#define MINIZ_ATTRIBUTE_DOS_INTEGRITY             ( 1  <<  3)
#define MINIZ_ATTRIBUTE_DOS_SYSTEM                ( 1  <<  2)
#define MINIZ_ATTRIBUTE_DOS_HIDDEN                ( 1  <<  1)
#define MINIZ_ATTRIBUTE_DOS_READ_ONLY             ( 1  <<  0)
#define MINIZ_ATTRIBUTE_DIRECTORY \
  (MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_DIRECTORY | MINIZ_ATTRIBUTE_DOS_DIRECTORY)
#define MINIZ_ATTRIBUTE_NORMAL \
  (MINIZ_ATTRIBUTE_UNIX_FILE_TYPE_REGULAR | MINIZ_ATTRIBUTE_DOS_ARCHIVE)
#define MINIZ_ATTRIBUTE_UNIX_PERMISSIONS_MASK 0x0fff0000
#define MINIZ_ATTRIBUTE_DOS_ATTRIBUTES_MASK   0x0000003f
